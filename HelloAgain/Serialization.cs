//Serialization is the proccess of converting your objects into stream of bytes (000110001), JSON (Javascript object notation) or xml
//We will be using json file since it is the most popular format for storing and transferring data to other computers
